...
- Modify/audit: `docs/dev/architecture.md`
- Modify/audit: `docs/guide/commands.md`
- Modify/audit: `docs/guide/integration.md`
- Modify/audit: `docs/dev/json-output.md`
- Modify/audit: `docs/dev/new-provider.md`
- Modify/audit: `docs/dev/omarchy-shell.md`
- Modify/audit: `docs/dev/releasing.md`
- Modify/audit: `docs/guide/runtime.md`
- Modify/audit: `docs/guide/troubleshooting.md`
- Modify/audit: `docs/dev/agents/domain.md`
- Audit: `docs/dev/agents/issue-tracker.md`
- Audit: `docs/dev/agents/triage-labels.md`
