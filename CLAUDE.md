...
This file is the canonical guidance for coding agents in this repo. `AGENTS.md`
is a thin shim that delegates here. **The code in `src/` is the ultimate source
of truth** — when this document and the code disagree, the code wins; fix the
drift here.
