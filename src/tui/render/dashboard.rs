...
/// Cor de severidade direta, sem modulação (v8: pulso removido — spec §6).
...
mod tests {
    ...
    // Pulso crítico (Task 16) removido em v8 (spec §6): gauge agora é
    // sólido, sem modulação de brilho — os testes que confirmavam o pulso
    // saíram junto.
}
